...
JNAMESPACE JDM {
    JNAMESPACE KeyCode {
        ...
        JCCHAR *KeyCodeToString(JBOOL *Key) {
            JIF (&JDM::KeyCode::A == Key) JRETURN "A"; JIF (&JDM::KeyCode::B == Key) JRETURN "B";
            JIF (&JDM::KeyCode::C == Key) JRETURN "C"; JIF (&JDM::KeyCode::D == Key) JRETURN "D";
            JIF (&JDM::KeyCode::E == Key) JRETURN "E"; JIF (&JDM::KeyCode::F == Key) JRETURN "F";
            JIF (&JDM::KeyCode::G == Key) JRETURN "G"; JIF (&JDM::KeyCode::H == Key) JRETURN "H";
            JIF (&JDM::KeyCode::I == Key) JRETURN "I"; JIF (&JDM::KeyCode::J == Key) JRETURN "J";
            JIF (&JDM::KeyCode::K == Key) JRETURN "K"; JIF (&JDM::KeyCode::L == Key) JRETURN "L";
            JIF (&JDM::KeyCode::M == Key) JRETURN "M"; JIF (&JDM::KeyCode::N == Key) JRETURN "N";
            JIF (&JDM::KeyCode::O == Key) JRETURN "O"; JIF (&JDM::KeyCode::P == Key) JRETURN "P";
            JIF (&JDM::KeyCode::Q == Key) JRETURN "Q"; JIF (&JDM::KeyCode::R == Key) JRETURN "R";
            JIF (&JDM::KeyCode::S == Key) JRETURN "S"; JIF (&JDM::KeyCode::T == Key) JRETURN "T";
            JIF (&JDM::KeyCode::U == Key) JRETURN "U"; JIF (&JDM::KeyCode::V == Key) JRETURN "V";
            JIF (&JDM::KeyCode::W == Key) JRETURN "W"; JIF (&JDM::KeyCode::X == Key) JRETURN "X";
            JIF (&JDM::KeyCode::Y == Key) JRETURN "Y"; JIF (&JDM::KeyCode::Z == Key) JRETURN "Z";
            ...
            JIF (&JDM::KeyCode::N0 == Key) JRETURN "0"; JIF (&JDM::KeyCode::N1 == Key) JRETURN "1";
            JIF (&JDM::KeyCode::N2 == Key) JRETURN "2"; JIF (&JDM::KeyCode::N3 == Key) JRETURN "3";
            JIF (&JDM::KeyCode::N4 == Key) JRETURN "4"; JIF (&JDM::KeyCode::N5 == Key) JRETURN "5";
            JIF (&JDM::KeyCode::N6 == Key) JRETURN "6"; JIF (&JDM::KeyCode::N7 == Key) JRETURN "7";
            JIF (&JDM::KeyCode::N8 == Key) JRETURN "8"; JIF (&JDM::KeyCode::N9 == Key) JRETURN "9";
